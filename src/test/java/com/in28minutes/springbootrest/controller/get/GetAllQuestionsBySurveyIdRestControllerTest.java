...
@WebMvcTest(controllers = GetAllQuestionsBySurveyIdRestController.class)
class GetAllQuestionsBySurveyIdRestControllerTest extends AbstractRestControllerTest {

  @InjectMocks
  private GetAllQuestionsBySurveyIdRestController getAllQuestionsBySurveyIdController;
